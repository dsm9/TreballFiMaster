...
Background: There is a registered user
  ...
  Scenario: Select a campaign from a list
    ...
    | name |
    |18-19 Assignatura-professor màsters P 1r S|
    |18-19 Assignatura-professor màsters P 2n S|
    |18-19 Assignatura-professor INEFC 2n S|
    |18-19 Pràctiques externes - estudiantat (GEM - 3P)|
    |18-19 Pràctiques externes INEFC – Alumnat|
    |18-19 Pràctiques externes INEFC – Tutor empresa|
    |18-19 Pràctiques externes INEFC – Tutor acadèmic|
    |18-19 Pràctiques externes - tutor acadèmic (GEM)|
    |18-19 Pràctiques externes - tutor acadèmic (UXXI)|
    |18-19 Titulats Grau AQU|
    |18-19 Titulats Doble Grau AQU|
    |19-20 Pràctiques externes - estudiantat (GEM - 1P)|
